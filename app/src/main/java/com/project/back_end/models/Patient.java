...
public class Patient {
    ...
    //      - Note: @JsonProperty(access = JsonProperty.Access.WRITE_ONLY) is added to maintain consistent security patterns with Doctor and Admin models, ensuring passwords do not leak in JSON API responses.
    @NotNull
    @Size(min = 6)
