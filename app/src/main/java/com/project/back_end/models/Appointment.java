...
public class Appointment {
    ...
    // 6. 'getEndTime' method:
    //    - Description:
    //      - This method calculates the end time of the appointment by adding one hour to the start time (appointmentTime).
    //      - Used for UI calculation and dynamic availability display without persisting an redundant column.
